...
create_table_stmt
  = a:KW_CREATE __ KW_TABLE __ ife:if_not_exists_stmt? __ t:table_name __ LPAREN __ cd:create_column_definition __ RPAREN __ te:table_engine? {
...
table_engine
  = 'ENGINE'i __ KW_ASSIGIN_EQUAL __ e:ident {
    return [{
      keyword: 'engine',
      symbol: '=',
      value: e
...
column_list
  = head:column_name tail:(__ COMMA __ column_name)* {
    ...
    const cols = [{ type: 'backticks_quote_string', value: head }];
    for (let i = 0; i < tail.length; i++) {
      columnList.add(`insert::${tail[i][3]}::${tail[i][3]}`);
      cols.push({ type: 'backticks_quote_string', value: tail[i][3] });
    }
    return cols;
  }
...
or_expr
  = head:and_expr tail:(__ KW_OR __ and_expr)* {
    return tail.reduce((result, element) => {
      return createBinaryExpr(element[2], result, element[3]);
    }, head);
  }
...
clickhouse_data_type
  ...
  / t:(KW_INT8 / KW_INT16 / KW_INT32 / KW_INT64) { return { dataType: t }; }
  / t:(KW_UINT8 / KW_UINT16 / KW_UINT32 / KW_UINT64) { return { dataType: t }; }
  / t:(KW_FLOAT32 / KW_FLOAT64) { return { dataType: t }; }
  / t:KW_UUID { return { dataType: t }; }
  / t:KW_ARRAY __ LPAREN __ dt:data_type __ RPAREN { return { dataType: t, elementType: dt }; }
  / t:KW_TUPLE __ LPAREN __ types:data_type_list __ RPAREN { return { dataType: t, elementTypes: types }; }
  / t:KW_MAP __ LPAREN __ kt:data_type __ COMMA __ vt:data_type __ RPAREN { 
    return { dataType: t, keyType: kt, valueType: vt }; 
  }
  / t:KW_NULLABLE __ LPAREN __ dt:data_type __ RPAREN { return { dataType: t, innerType: dt }; }
  / t:KW_DATETIME64 __ LPAREN __ precision:literal_numeric __ RPAREN { 
    return { dataType: t, precision: precision.value }; 
  }
...
datetime_type
  = t:(KW_DATE / KW_DATETIME / KW_TIMESTAMP) { return { dataType: t }; }
...
KW_DATETIME64 = "DATETIME64"i !ident_part { return 'DATETIME64'; }
...
KW_FLOAT32 = "FLOAT32"i !ident_part { return 'FLOAT32'; }
KW_FLOAT64 = "FLOAT64"i !ident_part { return 'FLOAT64'; }
...
KW_INT8 = "INT8"i !ident_part { return 'INT8'; }
KW_INT16 = "INT16"i !ident_part { return 'INT16'; }
KW_INT32 = "INT32"i !ident_part { return 'INT32'; }
KW_INT64 = "INT64"i !ident_part { return 'INT64'; }
...
KW_NULLABLE = "NULLABLE"i !ident_start { return 'NULLABLE'; }
...
KW_TUPLE = "TUPLE"i !ident_start { return 'TUPLE'; }
KW_TYPE = "TYPE"i !ident_start { return 'TYPE'; }
KW_UINT8 = "UINT8"i !ident_part { return 'UINT8'; }
KW_UINT16 = "UINT16"i !ident_part { return 'UINT16'; }
KW_UINT32 = "UINT32"i !ident_part { return 'UINT32'; }
KW_UINT64 = "UINT64"i !ident_part { return 'UINT64'; }
...
keyword = (
  ...
  KW_BETWEEN / KW_BOOLEAN / KW_BY / KW_CASE / KW_CHAR / KW_CHECK /
  KW_COLLATE / KW_COLUMN / KW_COMMENT / KW_CREATE / KW_CROSS /
  KW_CURRENT_DATE / KW_CURRENT_TIME / KW_CURRENT_TIMESTAMP /
  KW_DATABASE / KW_DATABASES / KW_DATE / KW_DATETIME / KW_DATETIME64 /
  KW_DECIMAL / KW_DEFAULT / KW_DELETE / KW_DESC / KW_DESCRIBE /
  KW_DISTINCT / KW_DOUBLE / KW_DROP / KW_ELSE / KW_END / KW_ENUM /
  KW_EXISTS / KW_EXPLAIN / KW_FALSE / KW_FLOAT / KW_FLOAT32 / KW_FLOAT64 /
  KW_FROM / KW_FULL / KW_FUNCTION / KW_GROUP / KW_HAVING / KW_IF /
  KW_IN / KW_INDEX / KW_INNER / KW_INSERT / KW_INT / KW_INT8 / KW_INT16 /
  KW_INT32 / KW_INT64 / KW_INTEGER / KW_INTERVAL / KW_INTO / KW_IS /
  KW_JOIN / KW_KEY / KW_LEFT / KW_LIKE / KW_LIMIT / KW_MAP / KW_NOT /
  KW_NULL / KW_NULLABLE / KW_ON / KW_OR / KW_ORDER / KW_OUTER /
  KW_PRIMARY / KW_REPLACE / KW_RIGHT / KW_SELECT / KW_SET / KW_SHOW /
  KW_STRING / KW_TABLE / KW_TABLES / KW_THEN / KW_TIME / KW_TIMESTAMP /
  KW_TRUE / KW_TUPLE / KW_TYPE / KW_UINT8 / KW_UINT16 / KW_UINT32 /
  KW_UINT64 / KW_UNION / KW_UPDATE / KW_USE / KW_USING / KW_UUID /
  KW_VALUES / KW_VARCHAR / KW_WHEN / KW_WHERE / KW_WITH
)
